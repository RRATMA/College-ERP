...
// --- DESIGNER: NEON GLOW & LOGO STYLES ---
const injectStyles = () => {
    ...
    <div style={hStyles.wrapper}>
      ...
      {tab === 'dashboard' && (
        <div style={hStyles.content}>
          ...
          <h4 style={{marginTop:'20px', fontSize:'12px', color:'#64748b'}}>RECENT ACTIVITY</h4>
    ...
    <div style={fStyles.mobileWrapper}>
      ...
      {setup.cl && (
        <div style={{marginTop:'20px'}}>
          ...
          <label style={fStyles.label}>TIME & MODE</label>
          <div style={{display:'flex', gap:'10px', marginBottom:'10px'}}><input type="time" onChange={e=>setSetup({...setup, start:e.target.value})} style={hStyles.input}/><input type="time" onChange={e=>setSetup({...setup, end:e.target.value})} style={hStyles.input}/></div>
...
const styles = {
  ...
  title: { fontSize:'32px', fontWeight:'900', color:'#ffffff', letterSpacing:'1px' },
...
const hStyles = {
  ...
  actionBtn: { width: '100%', padding: '15px', background: '#6366f1', color: '#fff', border: 'none', borderRadius: '12px', fontWeight: 'bold', marginBottom: '15px' },
...
const fStyles = {
  ...
  rollChip: { height:'85px', borderRadius:'18px', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' },
