  ...
  if (view === 'login') return (
    <div style={ui.loginWrap}>
      <div className="glass" style={ui.loginCard}>
        ...
        <button onClick={() => handleLogin(document.getElementById('u').value, document.getElementById('p').value)} style={{...ui.primaryBtn, marginTop:'25px'}}>ENTER SYSTEM <ChevronRight size={18}/></button>
      </div>
    </div>
  );
